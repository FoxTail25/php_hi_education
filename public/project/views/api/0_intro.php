...
<div class="task">
	...
	<code>
		<i>
			<b>К сожалению, предложенный выше API у меня не заработал. Я буду использовать API Центрального банка РФ <a href="https://www.cbr.ru/development/SXML/">получение котировок на заданный день</a></b> через него, можно получить котировки на указанный день в формате XML
		</i>
